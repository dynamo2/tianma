 ...
 * <li>{@link #addConstant addConstant(String,Object)} adds a 'constant' variable
 * whos value cannot be changed.
...
public class SymbolTable extends Hashtable {
	...
	/**
	 * Private default constructors, SymbolTable should always be constructed
	 * with an explicit variable factory.
	 */
	private SymbolTable() {
	}
