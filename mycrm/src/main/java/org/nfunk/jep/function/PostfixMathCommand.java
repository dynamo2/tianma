...
public class PostfixMathCommand implements PostfixMathCommandI {
	/**
	 * Number of parameters a the function requires. Initialize this value to -1
	 * if any number of parameters should be allowed.
	 */
	protected int numberOfParameters;

	/**
	 * Number of parameters to be used for the next run() invocation. Applies
	 * only if the required umber of parameters is variable (numberOfParameters
	 * = -1).
	 */
	...
	/**
	 * Checks the number of parameters of the function. Functions which set
	 * numberOfParameter=-1 should overload this method
	 * 
	 * @param n
