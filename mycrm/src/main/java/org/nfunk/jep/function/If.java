 ...
 * returned if condExpr is &lt;= 0 or Boolean.TRUE.
 * <p>
 * This function performs lazy evaluation so that only posExpr or negExpr will
 * be evaluated. For Complex numbers only the real part is used.
 * <p>
 ...
 * <p>
 * This function implements the SpecialEvaluationI interface so that it handles
...
public class If extends PostfixMathCommand implements CallbackEvaluationI {
	...
	/*
	 * Performs the specified action on an expression tree. Serves no function
	 * in standard JEP but
	 * 
	 ...
	 * 
	 * @throws ParseException public Node process(Node node,Object
	 * data,ParserVisitor pv) throws ParseException { return null; }
	 */
	/**
