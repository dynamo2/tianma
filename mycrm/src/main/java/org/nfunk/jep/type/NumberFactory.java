...
/**
 * This interface can be implemented to create numbers of any object type. By
 * implementing this interface and calling the setNumberFactory() method of the
 * JEP class, the constants in an expression will be created with that class.
 */
public interface NumberFactory {
	...
	/**
	 * Creates a number object from a class implementing Number, May actually
