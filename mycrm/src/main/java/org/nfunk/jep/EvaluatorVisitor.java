...
public class EvaluatorVisitor implements ParserVisitor, EvaluatorI {
	 ...
	 */
	/*
	 * protected void addToErrorList(String errorStr) { if (errorList != null) {
	 ...
	 *             if there is a problem with the evaluation.
	 */
	public Object getValue(Node topNode, SymbolTable symTab_in) throws ParseException {
		 ...
		 * this.addToErrorList("Error: "+e.getMessage()); return null; }
	...
	/*
	 * The following methods was used to facilitate using visitors which
	 * implemented a interface which sub-classed ParserVisitor.
	 * 
	 * If sub-classed to extend to implement a different visitor this method
	 * should be overwritten to ensure the correct accept method is called. This
	 * method simply calls the jjtAccept(ParserVisitor this,Object data) of
	 * node.
	 * 
	 * We no longer need this as we use ParseVisitor everywhere, but kept for
	 * future reference.
	 * 
