...
public class JEP {
	 ...
	 * return parseException.getColumn(); else return 0; }
	 * 
	 * /** Returns the line in which the last error occurred. / public int
	 * getErrorLine() { if (hasError && parseException != null) return
	 * parseException.getLine(); else return 0; }
	 */
}
