...
public class Parser/* @bgen(jjtree) */implements ParserTreeConstants, ParserConstants {/*
	...
	/**
	 * Continue parsing without re-initilising stream. Allows renetrancy of
	...
	/**
	 * Sets the initial state that the token manager is in. Can be used to
	 * change how x.x is interpreted, either as a single identifier (DEFAULT) or
	 * as x <DOT> x (NO_DOT_IN_IDENTIFIERS)
	 * 
	 * @param state
	...
	/*
	 * void RangeExpression() #FunNode: { jjtThis.setOperator(opSet.getRange());
	...
	/*
	 * Vector Array() : { Object value; Vector result = new Vector(); } { <LSQ>
	 * value = RealConstant() { result.addElement(value); } ( <COMMA> value =
	 * RealConstant() { result.addElement(value); } )* <RSQ> { return result; }
	 * }
	 */
	...
	private static void jj_la1_0() {
		jj_la1_0 = new int[] { 0x80001, 0x80001, 0x80001, 0x10000000, 0x8000000, 0x4800000, 0x4800000, 0x3600000,
				0x3600000, 0x60000000, 0x60000000, 0x80000000, 0x60000000, 0x0, 0xa80, 0x9000, 0x100000, 0x9000,
				0x100000, 0x9000, 0xa80, 0x280, };
	}

	private static void jj_la1_1() {
		jj_la1_1 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x27, 0x8, 0x10, 0x0, 0x140, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, };
	}
