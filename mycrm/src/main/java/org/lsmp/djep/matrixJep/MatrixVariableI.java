...
public interface MatrixVariableI {
	...
	/**
	 * Sets the dimension of the variable. Will also allocate appropriate space
	 * for value container.
	 */
	public abstract void setDimensions(Dimensions dims);

	/**
	 * Returns the value container of this variable. There is no setMValue as
	 * the value can be changed by setting the individual elements of value
	 * container.
	 */
