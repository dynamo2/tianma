...
/**
 * If a function requires a special form of evaluation it should implement this
 * interface.
 * 
...
public interface MatrixSpecialEvaluationI {
	/**
	 * Returns the result of evaluating this node and the tree below. This
	 * method has the responsibility for evaluating the children of the node and
	 ...
	 * 
	 * <p>
	 * The final results should be copied into the mvalue field of the node
	 * using
	 * 
	 * <pre>
