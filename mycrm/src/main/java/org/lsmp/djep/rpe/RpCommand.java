...
public final class RpCommand {
	...
	public String toString() {
		switch (command) {
		case RpEval.CONST:
			return "Constant\tno " + aux1;
		case RpEval.VAR:
			return "Variable\tnum " + aux1;
		case RpEval.ADD:
			return "ADD";
		case RpEval.SUB:
			return "SUB";
	...
	/**
	 * Returns the type of an individual command. The return value will be one
	 * of the constants defined in RpEval. These include RpEval.CONST -
	 * constants, RpEval.VAR - variables, RpEval.ASSIGN assinments x=...,
	 * RpEval.FUN functions. Other indicies correspond to unary and binary
	 * operators, RpEval.ADD.
	 * 
