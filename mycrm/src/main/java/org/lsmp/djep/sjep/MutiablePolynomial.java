...
/**
 * A mutable polynomial representing a + b + c. There are no requirements that
 * this is in a reduced form so some powers can be zero.
 * 
 * @author Rich Morris Created on 23-Dec-2004
 */
public class MutiablePolynomial {
	...
	/**
	 * Multiplies this by a polynomial and expands the results. (1+x)*(1+x) -->
	 * 1+2*x+x^2
	 * 
	 * @param p
	...
	/**
	 * Multiplies this by a node and expands the results. (1+x)*(1+x) -->
	 * 1+2*x+x^2
	 * 
	 * @param node
	 * @throws ParseException
