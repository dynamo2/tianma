...
/**
 * An element in a polynomial representation of an expression. Provides the main
 * routines for creating, comparing and manipulating polynomials.
 * 
 * @author Rich Morris Created on 17-Dec-2004
 */
public interface PNodeI {
	...
	/**
	 * Compares this expression to argument. Uses a total ordering of
	 * expressions. Returns positive if this node comes after the argument.
	 */
