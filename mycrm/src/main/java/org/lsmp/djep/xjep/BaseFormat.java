...
/**
 * A Number format object which prints results in a specified base. TODO Do
 * something with the FieldPosition arguments.
 * 
...
public class BaseFormat extends NumberFormat {
	 ...
	 *            the base of number to use
	 * @param prefix
	 *            prefix to appear before number
	 * @throws IllegalArgumentException
	 *             if base is < 2 or > 36
	 */
