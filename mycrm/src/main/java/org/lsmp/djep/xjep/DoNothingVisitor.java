...
/**
 * A Visitor which visits each node of a expression tree. It returns the top
 * node. This visitor should be extended by Visitors which modify trees in
 * place.
 * 
...
public abstract class DoNothingVisitor implements ParserVisitor {
	 ...
	 * implemented a interface which subclassed ParserVisitor.
	 * 
	 * If subclassed to extend to implement a different visitor this method
