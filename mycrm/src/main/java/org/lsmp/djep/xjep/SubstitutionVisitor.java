...
/**
 * Allows substitution of a given variable with an expression tree. Substitution
 * is best done using the {@link XJep#substitute(Node,String,Node)
 * XJep.substitute} method. For example
 * 
 * <pre>
 * XJepI xjep = ...;
...
public class SubstitutionVisitor extends DoNothingVisitor {
	...
	/**
	 * Substitutes all occurrences of variable var with replacement. Does not do
	 * a DeepCopy.
	 * 
	 * @param orig
	 *            the expression we wish to perform the substitution on
	 * @param name
	...
	/**
	 * Substitutes all occurrences of a set of variable var with a set of
	 * replacements. Does not do a DeepCopy.
	 * 
	 * @param orig
	 *            the expression we wish to perform the substitution on
	 * @param names
