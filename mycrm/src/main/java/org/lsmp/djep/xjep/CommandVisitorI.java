 ...
 * This interface should be implemented by PostFixMath Commands which wish to
 * perform a special action during the XJep.preprocess() method.
 */
public interface CommandVisitorI {
	 ...
	 * @param children
	 *            the children of the node after they have been preprocessed.
	 * @param xjep
