...
/**
 * The field of Reals represented by BigDecimals. TODO Sorry power is not
 * implemented.
 * 
 * @see BigDecimal
 * 
...
public class BigReals extends Group implements FieldI, OrderedSetI {
	...
	/**
	 * Create a field of BigIntegers. The round mode and scale are used during
	 * the div method which calls
	 * {@link java.math.BigDecimal#divide(BigDecimal,int,int)}. if scale is
	 * negative then the {@link java.math.BigDecimal#divide(BigDecimal,int)}. is
	 * called instead.
	 */
