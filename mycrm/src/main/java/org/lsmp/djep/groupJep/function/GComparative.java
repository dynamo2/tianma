...
/**
 * Implements logical operations on a group. Will always return Boolean results.
 * 
 * @author Rich Morris Created on 06-Mar-2004
 */
public class GComparative extends PostfixMathCommand {
	 ...
	 * 
	 * @param id
	 *            should be Comparative.LT or GT, LE, GE, NE EQ
	...
	public void run(Stack inStack) throws ParseException {
		...
		if ((param1 instanceof Number) && (param2 instanceof Number)) {
			...
			inStack.push(flag ? Boolean.TRUE : Boolean.FALSE);// push the result
																// on the
																// inStack
