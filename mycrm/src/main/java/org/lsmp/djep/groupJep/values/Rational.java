...
/**
 * A Rational number with full precision. Represented as quotien of two numbers
 * (always in most reduced form with posative denominator).
 * 
...
public class Rational extends Number implements Comparable {
	...
	/**
	 * Rationals will always be represented in most reduced form with a positive
	 * denominator.
	 */
