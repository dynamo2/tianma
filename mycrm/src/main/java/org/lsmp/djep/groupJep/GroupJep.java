...
/**
 * An extension of JEP which allows calculations over arbitary groups, such as
 * the integers(exact answers) and rationals.
 * 
...
public class GroupJep extends JEP {
	...
	/**
	 * Calcuates the value of the expression and returns the result as a complex
	 * number.
	 */
	 ...
	 * @return the complex aproximation or null if conversion to complex is not
	 *         posible.
	 **/
