...
public interface GroupI {
	...
	/**
	 * returns a number factory for creating group elements from strings. Most
	 * groups which are subclasses of
	 * {@link org.lsmp.djep.groupJep.groups.Group Group} do not need to implement
	 * this method.
	 */
	...
	/**
	 * For groups like rings of polynomials this determins if a given element is
