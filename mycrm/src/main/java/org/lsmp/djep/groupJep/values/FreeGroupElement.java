...
public class FreeGroupElement extends Polynomial implements HasComplexValueI {
	 ...
	 *            the free group.
	 * @param coeffs
	 *            array of coefficients for this element c0 + c1 t + ... + cn
	 *            t^n
	 */
	...
	/**
	 * Returns an approximation to the complex number representing this
	 * algebraic number. This only gives meaningful results if setRootValue has
	 * been called or if it is a quadratic extension (t^2+b t+c) or if it is a
	 * simple n-th root (t^n+a). In the last two cases the root value is
