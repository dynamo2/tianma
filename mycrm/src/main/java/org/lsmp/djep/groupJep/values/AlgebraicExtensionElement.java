...
/**
 * An element of the algrabraic extension K(t). a0 + a1 t + a(n-1) t^(n-1) where
 * t is defined to be the the solution of a polynomial equation.
 * 
...
public class AlgebraicExtensionElement extends FreeGroupElement {
	...
	/**
	 * An element of the algebraic extension K(t). a0 + a1 t + a(n-1) t^(n-1)
	 * where t is defined to be the the solution of a polynomial equation. If
	 * the degree of the polynomial specified by coeffs is greater than n then
	 * the polynomial will be reduced by using the equation t^n = .....
	 * 
	 * @param K
	 *            the algebraic extension.
	 * @param coeffs
	 *            array of coefficients for this algebraic number. c0 + c1 t +
	 *            ... + cn t^n
	 */
