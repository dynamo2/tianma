 ...
 */
public class Integers extends Group implements IntegralDomainI, HasDivI, OrderedSetI, HasModI, HasPowerI {
	...
	/*
	 * note -3 mod 2 is 1 rather than -1 as for % in java language
	 * specifications.
	 */
