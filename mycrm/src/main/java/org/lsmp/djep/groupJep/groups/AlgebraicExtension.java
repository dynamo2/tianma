...
/**
 * An Algebraic Extension of a Ring. The ring generated by {1,t,...,t^n-1} where
 * t is an algebraic number i.e t is be a root of a monic polynomial equation.
 * 
...
public class AlgebraicExtension extends ExtendedFreeGroup implements RingI {
	 ...
	 * 
	 * @param K
	 *            the Ring this is an extension of.
	 * @param poly
	 *            A monic polynomial whose solution gives an algebraic number
	 *            which is used to generate this group.
	...
	public AlgebraicExtension(RingI K, Polynomial poly) {
		...
		// test for monic
		if (!baseRing.equals(poly.getCoeffs()[poly.getDegree()], baseRing.getONE()))
		...
		zeroPoly = new AlgebraicExtensionElement(this, new Number[] { baseRing.getZERO() });
		// construct the unit poly
		unitPoly = new AlgebraicExtensionElement(this, new Number[] { baseRing.getONE() });
		// construct the polynomial t
		tPoly = new AlgebraicExtensionElement(this, new Number[] { baseRing.getZERO(), baseRing.getONE() });
	}
	...
	/**
	 * Returns the polynomial -a_(n-1) t^(n-1) + ... + a_0. This polynomial is
	 * used in reducing the equation t^n
	 */
