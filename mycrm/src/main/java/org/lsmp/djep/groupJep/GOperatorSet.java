...
/**
 * The set of operators used in the parser. Actual function and suported
 * operators are defined by the group and the interfaces it supports.
 * 
 * @author Rich Morris Created on 07-Mar-2004
 */
public class GOperatorSet extends OperatorSet {

	/**
	 * TODO Should really change the properties of operators, might muck up
	 * simplification.
	 */
