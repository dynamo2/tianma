...
public class ExpandBrackets extends AbstractRewrite {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.lsmp.djep.xjep.RewriteRuleI#apply(org.nfunk.jep.Node,
	 * org.nfunk.jep.Node[])
	 */
	public Node apply(ASTFunNode node, Node[] children) throws ParseException {
		...
		if (lhsOp == opSet.getAdd() || lhsOp == opSet.getSubtract()) { /*
																		 ...
																		 * (b*c)
																		 */
			return nf.buildOperatorNode(lhsOp,
					nf.buildOperatorNode(opSet.getMultiply(), children[0].jjtGetChild(0), xj.deepCopy(children[1])),
		...
		if (rhsOp == opSet.getAdd() || rhsOp == opSet.getSubtract()) { /*
																		 ...
																		 * (a*c)
																		 */
			return nf.buildOperatorNode(rhsOp,
					nf.buildOperatorNode(opSet.getMultiply(), xj.deepCopy(children[0]), children[1].jjtGetChild(0)),
