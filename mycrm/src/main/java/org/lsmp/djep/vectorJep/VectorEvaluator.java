...
public class VectorEvaluator extends EvaluatorVisitor {
	...
	public Object visit(ASTFunNode node, Object data) throws ParseException {
		...
		if (pfmc instanceof SpecialEvaluationI) {
			return ((SpecialEvaluationI) node.getPFMC()).evaluate(node, data, this, stack, this.symTab);
		}
		...
		if (pfmc instanceof UnaryOperatorI || pfmc instanceof BinaryOperatorI || pfmc instanceof NaryOperatorI
