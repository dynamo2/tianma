 ...
 * First argument is a equation, second argument is the name or names of
 * variables. Third and subsequent arguments are vectors or matrices, they must
 * have the same dimensions and the number of subsequent arguments must match
 * the number of variables specified in the second argument.
 * 
