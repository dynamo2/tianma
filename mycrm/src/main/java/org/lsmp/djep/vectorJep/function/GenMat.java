 ...
 * or matrix. Third argument (if present gives free variables used in the
 * function, these will run from 1 to number of rows or columns). For example
 * 
 * <pre>
 * GenMat(3,1) -> [1,1,1]
 ...
 * </pre>
 * 
 * Note the free variables should not be the same name as variables already in
 * use, in particular i is often set to be the complex root of unity, and should
 * be avoided.
 * 
