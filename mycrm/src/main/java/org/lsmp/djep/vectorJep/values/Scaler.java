 ...
 * @version 1.3.0.2 now extends number TODO don't implement number! So what if a
 *          scaler is a boolean
 */
public class Scaler extends Number implements MatrixValueI {
	...
	public int intValue() {
		...
		return ((Number) value).intValue(); // throws a cast exception if not a
											// number
	}
	...
	public long longValue() {
		...
		return ((Number) value).longValue(); // throws a cast exception if not a
												// number
	}
	...
	public float floatValue() {
		...
		return ((Number) value).floatValue(); // throws a cast exception if not
												// a number
	}
	...
	public double doubleValue() {
		...
		return ((Number) value).doubleValue(); // throws a cast exception if not
												// a number
	}
