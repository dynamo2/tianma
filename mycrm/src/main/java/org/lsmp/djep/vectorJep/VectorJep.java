...
/**
 * An extension of JEP with support for basic vectors and matrices. Use this
 * class instead of JEP if you wish to use vectors and matrices.
 * 
...
public class VectorJep extends JEP {
	 ...
	 * element. Otherwise multiplication will be matrix multiplication (the
	 * default).
	 */
