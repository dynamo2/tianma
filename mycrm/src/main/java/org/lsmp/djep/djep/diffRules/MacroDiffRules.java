...
/**
 * Rules are specfied by a set of strings or trees of nodes. The standard chain
 * rule is applied
 * 
 * <pre>
...
public class MacroDiffRules extends ChainRuleDiffRules {
	 ...
	 *            name of function
	 * @param node
	 *            a tree represention differation of function wrt "x"
	 ...
	 *            name of function
	 * @param rule
	 *            a string represention differation of a function wrt "x"
	 * @throws ParseException
	 */
	...
	/**
	 * Create a differention rule for function with 2 arguments. The rules must
	 ...
	 *            a string represention differation of function wrt "x"
	 * @param rule2
	 *            a string represention differation of function wrt "y"
	 * @throws ParseException
	 */
	public MacroDiffRules(DJep djep, String inName, PostfixMathCommandI inPfmc, String rule1, String rule2)
			throws ParseException {
		// super(dv);
		name = inName;
		pfmc = inPfmc;
	 ...
	 *            PostfixMathCommandI for function
	 * @param node1
	 *            a expression tree represention differation of function wrt "x"
	 * @param node2
	 *            a expression tree represention differation of function wrt "y"
	 * @throws ParseException
	 */
	/*
	 * public MacroDiffRules(DJep djep,String inName,PostfixMathCommandI
	 * inPfmc,Node node1,Node node2) throws ParseException { //super(dv); name =
	 * inName; pfmc = inPfmc; if(pfmc!=null) { int nParam =
	 * pfmc.getNumberOfParameters(); if(nParam != 2) throw new
	 * ParseException("Number of rules must match number of parameters for "
	 * +inName+" which is "+nParam); } rules = new Node[2]; rules[0] = node1;
	 * rules[1] = node2; //fixVarNames(); }
	 */
	/**
	 * Create a differention rule for function with 2 arguments. The rules must
	 * be in terms of "x" and "y"
	 ...
	 */
	/*
	 * public MacroDiffRules(DJep djep,String inName,Node node1,Node node2)
	 * throws ParseException {
	 * this(djep,inName,djep.getFunctionTable().get(inName),node1,node2); }
	 *//**
	 * Create a differentation rule for function with n arguments. The rules
	 * must be in terms of "x1", "x2", ... "xn"
	 * 
	 * @param inName
	 *            name of function
	 * @param inPfmc
	 ...
	 *            name of function
	 * @param inRules
	 *            an array of strings representation differentation of function
	 *            wrt "x1",...
	 * @throws ParseException
	 */
	 ...
	 *            PostfixMathCommandI for function
	 * @param inRule
	 *            an array of expression trees representation differentation of
	 *            function wrt "x1",...
	 * @throws ParseException
	 */
	/*
	 * public MacroDiffRules(DJep djep,String inName,PostfixMathCommandI
	 * inPfmc,Node[] inRules) throws ParseException { //super(dv); name =
	 * inName; pfmc = inPfmc; if(pfmc!=null) { int nParam =
	 * pfmc.getNumberOfParameters(); if(nParam != inRules.length) throw new
	 * ParseException
	 * ("Number of rules must match number of parameters for "+inName
	 * +" which is "+nParam); } rules = inRules; //fixVarNames(); }
	 */
	/**
	 * Create a differentation rule for function with n arguments. The rules
	 * must be in terms of "x1", "x2", ... "xn"
	 ...
	 */
	/*
	 * public MacroDiffRules(DJep djep,String inName,Node[] inRules) throws
	 * ParseException {
	 * this(djep,inName,djep.getFunctionTable().get(inName),inRules); }
	 */
} /* end MacroDiffRules */
