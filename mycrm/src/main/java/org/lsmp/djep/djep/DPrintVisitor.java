...
/**
 * An extension of PrintVisitor which will print the equations of a variable if
 * required. The behaviours of this class is determined by two modes
...
public class DPrintVisitor extends PrintVisitor {
	...
	/**
	 * Prints the variable or its equation. Depends on the state of the flags
	 * and whether the variable has an equation.
	 */
