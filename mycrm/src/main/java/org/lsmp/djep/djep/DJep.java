...
public class DJep extends XJep {
	...
	/**
	 * Adds the standard set of differentation rules. Corresponds to all
	...
	public boolean addStandardDiffRules() {
		try {
			...
			addDiffRule(new MacroDiffRules(this, "log", // -> (1/ln(10)) /x =
														// log(e) / x but don't
														// know if e exists
					this.getNodeFactory().buildOperatorNode(this.getOperatorSet().getDivide(),
							this.getNodeFactory().buildConstantNode(this.getTreeUtils().getNumber(1 / Math.log(10.0))),
