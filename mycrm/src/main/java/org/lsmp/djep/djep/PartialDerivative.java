...
/**
 * Contains infomation about a PartialDerivative of a variable. Should
 * 
 * @author Rich Morris Created on 29-Oct-2003
 */
public class PartialDerivative extends XVariable implements Observer {
	 ...
	 * findDerivative method in {@link DVariable DVariable}.
	 **/
	...
	protected PartialDerivative(DVariable var, String derivnames[], Node deriv) {
		 ...
		 * System.out.println("Warning constant derivative "
		 * +printString+"="+((ASTConstant) deriv).getValue());
		 * this.setValue(((ASTConstant) deriv).getValue()); } else
		 */
		setEquation(deriv);
	}
	...
	/**
	 * Every partial derivative has a root variable for instance the root
	 * variable of dy/dx is y. This method returns than variable.
	 */
	...
	/**
	 * When the value of the root object is changed makes the value of this
	 * partial derivative invalid.
	 * 
