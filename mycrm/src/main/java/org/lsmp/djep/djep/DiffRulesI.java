...
/**
 * Holds a set of rules describing how to differentiate a function. Each
 * function to be differentiated should have a object which implements this
 * interface.
 * 
...
public interface DiffRulesI {
	...
	/**
	 * Returns the top node of of the derivative of this function wrt to
	 * variable var.
	 * 
	 * @param var
	...
	/**
	 * Returns the name of the function. Used as index in hashtable and as way
	 * of linking with standard JEP functions. You probably want to specify the
	 * in the constructors.
	 */
