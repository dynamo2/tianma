...
public class InExpression extends ComparisonExpression {
	public InExpression(String f,List<Object> fv){
		super(f,fv,Operator.IN);
	...
	public InExpression(String source,Map<String,Object> paramMap){
		super(source,paramMap,Operator.IN);
